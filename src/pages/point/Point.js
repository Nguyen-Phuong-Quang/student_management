...
import { StoreContext, actions, infoField2, headerTable } from '../store'
...
function Point() {
  ...
  const handleSearch = () => {
    ...
    if(noInputInfo == infoField2.length) {
